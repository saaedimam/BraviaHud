...
public class ViewPager extends ViewGroup {
    ...
    /* JADX WARN: Code duplicated, block: B:70:0x0157 A[PHI: r7 r10 r15
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() != 8 && (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) != null && layoutParams2.isDecor) {
                ...
                int i9 = layoutParams2.gravity & com.sony.dtv.b2b.prosettings.R.styleable.AppCompatTheme_windowFixedHeightMajor;
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isDecor) {
                    ...
                    int i10 = layoutParams.gravity & com.sony.dtv.b2b.prosettings.R.styleable.AppCompatTheme_windowFixedHeightMajor;
                    if (i9 == 1) {
    ...
    private boolean pageScrolled(int i) {
        ...
        float f3 = ((i / f) - itemInfoInfoForCurrentScrollPosition.offset) / (itemInfoInfoForCurrentScrollPosition.widthFactor + f2);
        this.mCalledSuper = false;
