...
public class AnimatorInflaterCompat {
    ...
    private static int inferValueTypeOfKeyframe(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        ...
        int i = 0;
        TypedValue typedValuePeekNamedValue = TypedArrayUtils.peekNamedValue(typedArrayObtainAttributes, xmlPullParser, HotelSettings.VALUE, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (z) {
            if (i != 3) {
                switch (i) {
                    case 0:
                        keyframeOfInt = Keyframe.ofFloat(namedFloat, TypedArrayUtils.getNamedFloat(typedArrayObtainAttributes, xmlPullParser, HotelSettings.VALUE, 0, 0.0f));
                        break;
                    case 1:
                        keyframeOfInt = Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(typedArrayObtainAttributes, xmlPullParser, HotelSettings.VALUE, 0, 0));
                        break;
                    default:
                        keyframeOfInt = null;
                        break;
