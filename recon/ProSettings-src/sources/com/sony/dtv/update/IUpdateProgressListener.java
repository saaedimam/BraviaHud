...
public interface IUpdateProgressListener extends IInterface {
    void onPayloadApplicationComplete(int i) throws RemoteException;

    void onStatusUpdate(int i, float f) throws RemoteException;

    public static abstract class Stub extends Binder implements IUpdateProgressListener {
        private static final String DESCRIPTOR = "com.sony.dtv.update.IUpdateProgressListener";
        ...
        public static IUpdateProgressListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IUpdateProgressListener)) {
                return (IUpdateProgressListener) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements IUpdateProgressListener {
